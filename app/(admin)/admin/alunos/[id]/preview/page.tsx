    ...
    <div className="space-y-10">
      ...
      {ultimoAcessado && (
        <div className="block rounded-lg border border-gray-200 p-4">
          <p className="text-xs text-gray-400 uppercase tracking-wide mb-1">Continuar de onde parou</p>
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Seu progresso</h2>
        <div className="rounded-lg border border-gray-200 p-4 space-y-2">
          ...
          <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
            <div className="h-full bg-black rounded-full" style={{ width: `${percentualGeral}%` }} />
          </div>
        </div>
      ...
      {totalMateriais === 0 && <p className="text-sm text-gray-500">Nenhum material liberado ainda.</p>}
    </div>
  );
}
