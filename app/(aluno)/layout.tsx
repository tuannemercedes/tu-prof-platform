...
export default async function AlunoLayout({
  ...
  const [{ data: materiaisRows }, { data: fasesRows }, { data: progresso }, { data: config }, { data: clubeConfig }, { data: glossarioConfig }, novidades] =
    await Promise.all([
      supabase
        .from("materiais")
  ...
  const temGlossario = !!glossarioConfig;
